...
% 
% [l,dl,surrugatedata] = llba2epcxb(x,D,mu,nui,doprior,options);
% 
...
% constrained Pavlovian bias parameters for conflict and non-conflict stimuli
% 
...
epsilon 	= exp(x(3:4));				% 'pavlovian' parameters. Weigth of Vcue into Qgo

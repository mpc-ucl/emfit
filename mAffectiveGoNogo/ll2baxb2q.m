function [l,dl,dsurr] = ll2baxb2q(x,D,mu,nui,doprior,options);
% 
% [l,dl,surrugatedata] = ll2baxb2q(x,D,mu,nui,doprior,options);
% 
% log likelihood (l) and gradient (dl) of simple RW model with irreducible
% noise, constant bias and separate reward and loss sensitivities, and
